							...
							<div className='column left-column'>
								<section className='intro-section'>
									<p className='intro-text'>
										<b>Co-curriculum Record - Student Development Porfolio (CCP)</b> is part of VinUniversity’s
										commitment to developing holistic graduates. This Portfolio documents the co-curricular experiences
										and developmental activities that students engage in during their time at VinUni, capturing evidence
										of their competencies, growth, and contributions beyond academic performance.
									</p>
								...
								<section className='projects-section'>
									<h2 className='section-title gold-text'>
										<img src={Skills} style={{ width: 25, marginLeft: -4, marginTop: -4 }} /> Featured
										Projects/Experience
									</h2>
