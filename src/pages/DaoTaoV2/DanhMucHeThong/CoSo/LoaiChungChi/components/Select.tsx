 ...
 */
const SelectLoaiChungChi = (props: {
	value?: string;
	...
	const { danhSach, getAllModel, visibleForm } = useModel('daotaov2.danhmuc.loaichungchi');
	...
	return (
		<Select
			...
			placeholder={placeholder ?? 'Chọn loại chứng chỉ'}
...
export default SelectLoaiChungChi;
